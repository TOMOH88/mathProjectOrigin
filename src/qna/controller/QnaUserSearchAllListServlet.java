...
/**
 * Servlet implementation class QnaUserSearchAllListServlet
 */
@WebServlet("/quslist")
public class QnaUserSearchAllListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QnaUserSearchAllListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(qList.size() > 0) {
			view = request.getRequestDispatcher("views/qna/qnaUserListView.jsp");
