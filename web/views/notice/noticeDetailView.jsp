...
<div class="content">
		...
		<tr>
			...
			<td style="font-family: 'Jua', sans-serif;"><%=notice.getNoticeTitle() %></td>
		</tr>
		<tr>
			<th style="font-family: 'Jua', sans-serif;">작성자</th>
			<td style="font-family: 'Jua', sans-serif;"><%=notice.getWriterName()%></td>
		</tr>
		<tr>
			<th style="font-family: 'Jua', sans-serif;">글내용</th>
