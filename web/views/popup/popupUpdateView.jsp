...
<input type="hidden" name="imagelink" value="<%=popup.getPopupImagePath() %>">
	...
	<tr>
		...
		<tr>
			...
			<input type="date" name="startDate" id="startDate"  value="<%= popup.getPopupDate() %>">
			~
			<label for="endDate">종료일</label>
			<input type="date" name="endDate" id="endDate"  value="<%= popup.getPopupEndDate() %>">
		</td>
		</tr>
		<tr>
			<th>링크주소</th>
			<td><input type="text" name="imgl" id="imgl" value="<%= popup.getPopupImgLink() %>"></td>
		</tr>
		<tr>
			<th>내용</th>
