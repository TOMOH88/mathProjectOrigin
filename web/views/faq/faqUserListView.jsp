...
<div class="page-header header-filter" data-parallax="true" style="background-image: url('/math/resources/images/math-3986758_1920.jpg')">
   ...
   <div class="main main-raised">
    <div class="container">
      <div class="section text-center">
        <div id="accordion">
  <div class="card">
    <div class="card-header card-header-rose" id="heading0">
        <button style="float:left;"class="btn btn-link btn-lg" data-toggle="collapse" data-target="#collapse0" aria-expanded="true" aria-controls="collapse0">
          <div class="card-text">
  ...
  <div class="card">
    <div class="card-header card-header-rose" id="heading<%= i %>">
      <button style="float:left;"class="btn btn-link btn-lg" data-toggle="collapse" data-target="#collapse<%= i %>" aria-expanded="true" aria-controls="collapse<%= i %>">
          <div class="card-text">
